...
<html lang="en">
    ...
    <body>
        ...
        <form action="Exito.php" method="POST" id="formulario">
            <table align="center">
                <tr>
                    <td width="497">COMPLETE LAS PÁGINAS 1-5</td>
                    <td width="200">Fecha: <input type="date" name="fecha" required/></td>
                </tr>
            </table>
            <table align="center">
                <tr>
                    <td width="700">Nombre: <br /><input class="adjustinput" type="text" name="nombre" id="nombre" onkeydown="return /[A-zÀ-ž\s\.]/i.test(event.key)" required/></td>
                </tr>
                <tr>
                    <td>Apellido<span class="tab">Nombre<span class="tab">Segundo nombre<span class="tab">Apellido de soltero/a</td>
                </tr>
                <tr>
                    <td>Dirección actual: <br /><input class="adjustinput" type="text" name="direccion" id="direccion" onkeydown="return /[A-zÀ-ž0-9\s\.\#]/i.test(event.key)" required/></td>
                </tr>
                <tr>
            ...
            <table align="center">
                <tr>
                    <td width="447">Tiempo de residencia: <br /><input class="adjustinput" type="text" name="tiempo" id="tiempo" onkeydown="return /[A-zÀ-ž0-9\s]/i.test(event.key)" required/></td>
                    <td width="250">Número de seguridad social: <br /><input class="adjustinput" type="number" step="1" name="nss" min="10000000000" max="99999999999" required/></td>
                </tr>
            </table>
            <table align="center">
                <tr>
                    <td width="700">Teléfono: <br /><input class="adjustinput" type="number" step="1" name="tel" min="1000000000" max="9999999999" required/></td>
                </tr>
                <tr>
                    <td width="700">Si es menor de 18 años, indique su edad: <br /><input class="adjustinput" type="number" step="1" name="edad" min="15" max="17" id="edad"/></td>
                </tr>
            </table>
            <table align="center">
                <tr>
                    <td width="507">Puesto que se solicita: <br /><input class="adjustinput" type="text" name="puesto" onkeydown="return /[A-zÀ-ž0-9\s\.]/i.test(event.key)" required/></td>
                ...
                <tr>
                    <td>Salario deseado: <br /><input class="adjustinput" type="number" name="salario" required/></td>
                </tr>
        </form>
                <tr>
